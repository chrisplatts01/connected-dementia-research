...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_jquery_validation__ = __webpack_require__(0);
...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(function () {
  ...
  var formValidation = (function () {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('form').validate()
  }())
  /**
    * IIFE to handle password show/hide
    */
  var passwordField = (function () {
    var $passwordField = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.input-field--password')
    ...
    var dropdownState = (function () {
      return {
        init: function ($select) {
          ...
          var $dropdown = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(dropdown).appendTo($select)
          var $selected = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(selected).appendTo($dropdown)
          var $options = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(options).appendTo($dropdown)
          var $option
          ...
          $select.find('option').not(':selected').each(function () {
            ...
            var text = $this.text()
            var value = $this.val()
            $option = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(option).appendTo($options)
            $option.text(text)
  ...
  var fileUpload = (function () {
    ...
    if (isAdvancedUpload) { // Handle advanced file upload
      ...
      .on('dragover dragenter', function () {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()(this).addClass('is-dragover')
      })
